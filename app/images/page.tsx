...
export default async function ImagesPage() {
  ...
  return (
    <div className="haoye-images-page min-h-[100svh] bg-[var(--site-bg)] text-[var(--site-text-solid)]">
      <div className="mx-auto max-w-[1360px] px-6 pb-24 pt-28 md:px-10 md:pb-36 md:pt-36">
        ...
        <div className="haoye-images-list mt-20 md:mt-28">
          {(items ?? []).map((item, index) => {
            ...
            return (
              ...
              >
                <div className="grid grid-cols-1 gap-8 md:grid-cols-[96px_minmax(0,1fr)] md:gap-10">
                  <div className="haoye-images-rail flex items-start justify-between md:block">
                    <p className="haoye-images-index text-[11px] tracking-[0.18em] text-[var(--site-faint)]">
                      {String(index + 1).padStart(2, '0')}
                    </p>
                  </div>

                  <div className="haoye-images-stage">
                    <Link
                      href={href}
                      ...
                      {cover ? (
                        <>
                          <img
                            ...
                            className="haoye-images-cover h-[300px] w-full object-cover transition duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:scale-[1.02] group-hover:brightness-[1.04] md:h-[540px]"
                          />
                        ...
                        <div className="flex h-[300px] w-full items-center justify-center bg-[color:var(--site-border-soft)] text-[12px] tracking-[0.18em] text-[var(--site-faint)] md:h-[540px]">
                          NO IMAGE
                        </div>
                      )}
                    </Link>
                    ...
                    <div className="haoye-images-copy flex flex-col justify-between">
                      <div className="haoye-images-copy-inner">
                        <p className="haoye-images-item-kicker text-[10px] tracking-[0.24em] text-[var(--site-faint)]">
                          IMAGE SERIES
                        </p>

                        <h2 className="haoye-images-item-title mt-5 text-[26px] font-light leading-[1.35] text-[var(--site-text-solid)] md:text-[38px] md:leading-[1.28]">
                          {item.title ?? '未命名'}
                        </h2>
