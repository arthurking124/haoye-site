    ...
    const render = () => {
      ...
      if (timeSec > 6.5) {
        ...
        if (!sensoryTriggers.current.shockwave) {
           ...
           // 👑 恢复原始的深海重低音轰鸣 (极其深邃、悠长的空间感)
           const actx = new (window.AudioContext || (window as any).webkitAudioContext)()
           const osc = actx.createOscillator()
           const gain = actx.createGain()
           osc.type = 'sine'; 
           
           // 频率从 40Hz 开始，缓慢跌落到 10Hz，更沉稳
           osc.frequency.setValueAtTime(40, actx.currentTime); 
           osc.frequency.exponentialRampToValueAtTime(10, actx.currentTime + 1.5); 
           
           // 初始音量 0.5 更加克制，余音拉长到 1.5 秒
