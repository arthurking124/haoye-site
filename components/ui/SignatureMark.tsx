...
export default function SignatureMark() {
  ...
  useEffect(() => {
    ...
    const animatePath = (
      ...
      path.style.transition = `stroke-dashoffset ${durationMs}ms cubic-bezier(0.22, 1, 0.36, 1) ${delayMs}ms`
    }

    animatePath(main, 120, 1800)
    animatePath(accent, 1650, 420)
  ...
  return (
    <div className="w-[170px] text-[var(--site-faint)] opacity-95 md:w-[210px]">
      <svg
        ref={svgRef}
